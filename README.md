...
### Option A: Homebrew (Apple Silicon macOS)
...
[Releases](https://github.com/flowglad/onton/releases) for Apple Silicon macOS
or ARM64 and x86_64 Linux. Each archive contains `onton` and `onton-setsid-exec`.
