...
class Onton < Formula
  ...
  on_arm do
    url "https://github.com/flowglad/onton/releases/download/v0.36.0/onton-arm64-apple-darwin.tar.gz"
    sha256 "cd5000d8e06dcbf142e7eeab9e4bbe198d86e8fdd6ceb467f76decd7c98c4952"
  end
